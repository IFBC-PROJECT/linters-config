...
- [javascript-react-projects](./javascript-react-projects)
...
- [javascript-react-projects](./javascript-react-projects#troubleshooting)
- [next-projects](./react-redux#troubleshooting)

## Validation

Do not make any changes in config files - they represent style guidelines that you share with your team - which is a group of all IFBC developers.
